...
class PosterTests(unittest.TestCase):
    ...
    def test_browser_editor_is_local_and_has_core_exports(self) -> None:
        ...
        mls = (ROOT / "web" / "mls.js").read_text(encoding="utf-8")
        ...
        self.assertIn('id="generate-from-mls"', index)
        self.assertIn('src="mls.js"', index)
        ...
        self.assertIn("AuthorizedConnectorProvider", mls)
        self.assertIn("DemoMlsProvider", mls)
