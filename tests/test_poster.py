...
class PosterTests(unittest.TestCase):
    ...
    def test_browser_editor_is_local_and_has_core_exports(self) -> None:
        ...
        self.assertIn('aria-label="Export preflight"', index)
        self.assertIn("makeZip", script)
        self.assertIn("drawPoster", script)
        self.assertIn("data-preflight-action", script)
        self.assertIn("validateProject", core)
        self.assertIn("preflightPresentation", core)
        ...
        self.assertIn("buildMlsImportPlan", core)
